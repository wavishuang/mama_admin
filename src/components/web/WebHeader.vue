<template>
  <header class="flex items-center justify-between px-6 py-2 bg-white border-b-4 border-indigo-600">
    <div class="flex flex-1 items-center">
      ...
      <SearchInput v-model="searchText" v-if="page !== 'product'" />
      <div v-if="page === 'product'" class="flex-1 text-center">
        <p class="text-xl">澄品團購</p>
      </div>
    </div>
...
watch(() => searchText.value, val => {
  console.log('header search:', route.path, val)
})
/**
 * Logout
 */
