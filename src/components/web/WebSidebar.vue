    ...
    >
      <div class="flex items-center justify-center mt-8">
        <div class="flex items-center">
          <span class="mx-2 text-2xl font-semibold text-white">澄品團購</span>
        </div>
      </div>
      ...
      <nav class="mt-10">
        ...
        >
          ...
          <span class="mx-4">商品列表</span>
        </router-link>

        <!-- 新增商品 -->
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'ProductAdd' ? activeClass : inactiveClass]"
          to="/product_add"
        >
          <svg
            class="w-5 h-5"
